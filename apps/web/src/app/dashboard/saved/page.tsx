...
import { fetchPurchases, formatRelativeTime, toggleSaved, type PurchaseSummary } from "@/lib/purchases-client";
  ...
  return (
    <div className="flex-1 p-4 sm:p-6 lg:p-8">
      ...
      <p className="mt-1.5 max-w-lg text-sm text-muted-foreground">
        Slideshows you starred to reuse as a starting point — Regenerate reruns the same idea for a
        fresh take.
      </p>
                ...
                <div className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-all hover:border-foreground/20 hover:shadow-md">
                  <div className={cn("relative aspect-4/3 w-full", !thumbnailUrl && STRIPES)}>
                    ...
                    <button
                      ...
                      onClick={() => handleUnsave(purchase.id)}
